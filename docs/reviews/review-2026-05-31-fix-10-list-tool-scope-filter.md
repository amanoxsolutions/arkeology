---
type: code_review
title: Review Fix 10 — List Tool Scope Filter
description: Adds a scope $or filter to the list_artifacts vector query so it matches the scope filtering already applied in search_artifacts, reducing unnecessary cross-scope data retrieval.
tags: []
