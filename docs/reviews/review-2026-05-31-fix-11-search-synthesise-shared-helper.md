---
type: code_review
title: Review Fix 11 — Extract Shared Re-Fetch Helper for Search and Synthesise
description: Extracts the duplicated scope-filter construction and deduplicating re-fetch loop from search.py and synthesise.py into a shared _search_helper.py module to eliminate copy-paste divergence.
tags: []
